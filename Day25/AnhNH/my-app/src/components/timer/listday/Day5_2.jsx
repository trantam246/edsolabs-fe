...
import './style.css';
export default function Day52(props) {
  const options = ['Start', 'Delete'];
        ...
        <Col className="align-items-center border-bottom pb-2 pt-2 justify-content-lg-between col-12 list__item item__today">
          <Row>
            ...
            <Col className="col-lg-6 col-xs-12 d-flex justify-content-end align-items-center">
              ...
              <span className="ms-2 me-2 text-center">{props.time_spent === null ?  <CircularProgress></CircularProgress> : props.time_spent}</span>
              <span>
                <IconButton
                  aria-label="more"
