...
import imgSignIn from '../Image/sign-in.png';

const login = () => {
    return (
        <div className="container bg-main--primary">
            <div className="flex flex--column">
                <img src={imgSignIn} className="banner__img" alt="Banner img" />
                <h3 className="heading heading--small heading--opacity text-center">Welcome back!</h3>
                <h2 className="heading heading--bold text-center mb-37">Please, Login.</h2>
                <div className="page page--login">
                    <form action="#" className="form">
                        <div className="form__input form__input--account">
                            ...
                            <input type="email" defaultValue="johnsondoe@nomail.com" placeholder="Account" name="account" id="account" required />
                        </div>
                        <div className="form__input form__input--password">
                            ...
                            <input type="password" defaultValue="djfddofifhf" placeholder="Password" name="password" id="password" required />
                        </div>
                        <button type="submit" className="btn btn--violet btn--box-shadow flex">
                            Continue
                    ...
                    <Link to="/register" className="btn btn--opacity-25 btn--box-shadow flex">
                        Create an Account
                    </Link>
                </div>
            </div>
