...
export const Register = () => {
    const [inputValue,setInputValue] = useState({emailRe: '',passwordRe: ''});
    ...
    return (
        <div className="layout">
            ...
            <img className="header__banner" src="images/registerBanner.png" alt="register banner" />
        ...
        <form className="form" action="post">
            <div className="form__input">
                ...
                <input name="emailRe" type="email" placeholder="Username" value={inputValue.emailRe} onChange={handleChange} />
            </div>
            ...
            <div className="form__input form__input--password">
                ...
                <input name="passwordRe" type="password" placeholder="Password" value={inputValue.passwordRe} onChange={handleChange}/>
            </div>


            <div className="form__btn btn__register--top">
