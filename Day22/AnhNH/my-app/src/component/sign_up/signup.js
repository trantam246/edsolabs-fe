...
function SignUp() {
    return (
        <main className="layout layout-up">
            <img src="./img/Mask Group.png" alt="" className="signup__image" />
            <h4 className="layout__h4">Welcome Back!</h4>
            <h2 className="layout__h2">Please, Log In.</h2>
            <form action="#" method="post" className="form form__signup">
                <div className="form__row">
                    <svg xmlns="http://www.w3.org/2000/svg" width={17} height={18} viewBox="0 0 14 15" fill="none" className="form__row-icon">
                    ...
                    <input type="email" name="email" placeholder="johnsondoe@nomail.com" className="form__row-input" />
                </div>
                <div className="form__row form__row-pass">
                    <svg xmlns="http://www.w3.org/2000/svg" width={12} height={20} viewBox="0 0 12 20" fill="none" className="form__row-icon">
                    ...
                    <input type="password" name="password" placeholder="****************" className="form__row-input" />
                </div>
                <button type="submit" className="layout__btn layout__btn-up">Continue <svg xmlns="http://www.w3.org/2000/svg" heght={10} width={10} aria-hidden="true" focusable="false" data-prefix="fas" data-icon="angle-right" className="angle-right" role="img" viewBox="0 0 256 512">
                    <path fill="currentColor" d="M224.3 273l-136 136c-9.4 9.4-24.6 9.4-33.9 0l-22.6-22.6c-9.4-9.4-9.4-24.6 0-33.9l96.4-96.4-96.4-96.4c-9.4-9.4-9.4-24.6 0-33.9L54.3 103c9.4-9.4 24.6-9.4 33.9 0l136 136c9.5 9.4 9.5 24.6.1 34z" />
                </svg></button>
                <div className="layout__separator">Or</div>
                <Link to="/signin" className="layout__btn btn-link"> Create an Account</Link>
            </form>
        </main>
    );
}
