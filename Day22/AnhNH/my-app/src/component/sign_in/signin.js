...
function SignIn() {
    return (
        <main className="layout layout-in">
            <img src="./img/Mask Group2.png" alt="" className="signin__image" />
            <h4 className="layout__h4">Hi there!</h4>
            <h2 className="layout__h2">Let’s Get Started</h2>
            <form action="#" method="post" className="form form__signup">
                <div className="form__row">
                    ...
                    <input type="text" name="email" placeholder="Username" className="form__row-input" />
                </div>
                <div className="form__row form__row-pass">
                    ...
                    <input type="password" name="password" placeholder="password" className="form__row-input" />
                </div>
                <button type="submit" className="layout__btn layout__btn-in">Create an Account</button>
                <div className="layout__separator">Or</div>
                <Link to="/" className="layout__btn btn-link"> Log in</Link>
            </form>
        </main>
    );
}
